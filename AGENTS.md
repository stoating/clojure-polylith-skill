...
1. Treat `polylith/SKILL.md` as the entry point — it contains a decision table pointing to the right reference file for the task.
...
For Claude Code, the richer native format is `.claude-plugin/` + `polylith/SKILL.md`.
